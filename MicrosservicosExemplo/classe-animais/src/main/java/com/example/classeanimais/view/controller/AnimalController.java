package com.example.classeanimais.view.controller;
...
import com.example.classeanimais.service.AnimalService;
import com.example.classeanimais.view.model.AnimalModeloAlteracao;
import com.example.classeanimais.view.model.AnimalModeloInclusao;
import com.example.classeanimais.view.model.AnimalModeloResponse;
...
public class AnimalController {
    ...
    @PostMapping
    public ResponseEntity<AnimalModeloResponse> criarAnimal(@RequestBody @Validated AnimalModeloInclusao Animal) {
    ...
    public ResponseEntity<AnimalModeloResponse> atualizarAnimal(@PathVariable Integer id,
        @Validated @RequestBody AnimalModeloAlteracao Animal) {
        ModelMapper mapper = new ModelMapper();
        AnimalDto dto = mapper.map(Animal, AnimalDto.class);
